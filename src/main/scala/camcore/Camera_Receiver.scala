...
class Camera_Receiver(vp: VideoParams, ct: CameraType = ctOV2640, zoom: Boolean = false) extends Module {
  ...
  val u_Camera_Controller = Module(new Camera_Controller(vp, ct, zoom))
